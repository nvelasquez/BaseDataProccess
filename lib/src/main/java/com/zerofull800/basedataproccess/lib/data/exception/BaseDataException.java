...
public class BaseDataException extends Exception {
     ...
     */
    public BaseDataException(String detailMessage) {
        super(detailMessage);
    }
     ...
     * @param throwable
     */
    public BaseDataException(String detailMessage, Throwable throwable) {
     ...
     */
    public BaseDataException(Throwable throwable) {
        super(throwable);
    }
}
